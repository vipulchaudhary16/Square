            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="flex overflow-x-auto pb-4 gap-4 -mx-4 px-4 md:mx-0 md:px-0 md:grid md:grid-cols-3 md:gap-6 md:pb-0 snap-x snap-mandatory hide-scrollbar">
                        ...
                        <div className={`min-w-[85vw] sm:min-w-[300px] md:min-w-0 snap-center rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-700 flex-shrink-0 ${netPosition >= 0 ? 'bg-green-50 dark:bg-green-900/20 border-green-100 dark:border-green-800' : 'bg-red-50 dark:bg-red-900/20 border-red-100 dark:border-red-800'}`}>
