...
class _AddEditInvestmentScreenState
  ...
  Future<void> _submit() async {
    ...
    try {
      final amountInvested =
          double.parse(_amountInvestedController.text.replaceAll(',', ''));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Add Investment', style: AppTypography.screenTitle.copyWith(color: ink, fontSize: 18)),
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AmountInputField(controller: _amountInvestedController, autofocus: true),
                    ...
                    InputField(
                      label: 'Current value',
                      hint: 'Optional — defaults to amount invested',
